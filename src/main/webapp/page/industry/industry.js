...
layui.use(['laypage', 'layer', 'form'], function () {
    ...
    form.on('submit(formSave)', function(data){
	  $.post("/customer/industry/modifyOrSave",data.field,function(result){
	  	if(result.success){
	  		alert("操作成功");
	  		setTimeout(function () {
                        initPage(1, 8);
...
$('#addlayer').click(function () {
    var $ = layui.jquery;
	$.get('/customer/page/industry/add.html', function(str){
	  layer.open({
	    type: 1,
		  title: '添加',
		  closeBtn: 1,
